...
{"title":"Short headline (max 8 words)","body":"Polished announcement text here.","color":"blue"}`;
  ...
  app.get("/api/admin/applications/:id/agreement-pdf", async (req: Request, res: Response) => {
    try {
      ...
      doc.moveDown(0.2);
      doc.fontSize(9).fillColor("#666666").text("Mississauga, Ontario", { align: "center" });
      ...
      doc.fontSize(9).font("Helvetica").text(
        "This Subcontractor Agreement (the \"Agreement\") is entered into by and between 1001328662 Ontario Inc. (the \"Company\"), located in Mississauga, Ontario, and the above-named individual (the \"Contractor\"). The Contractor agrees to perform services as an independent subcontractor, NOT as an employee of the Company.",
        { lineGap: 3 }
      );
      doc.moveDown(0.3);
      doc.text(
      ...
      doc.fontSize(8).font("Helvetica").fillColor("#999999").text(
        "This document was generated by 1001328662 Ontario Inc., Mississauga, Ontario. For questions, contact admin@wfconnect.org",
        { align: "center" }
      );
